...
The mandate is intentionally short: route, cap/currency and pickup windows. Null optional payment, validity, cargo and conditions are expected; do not ask for them or invent values. Zero minimum payment means no restriction, not cash payment. Only price is negotiable. SQL remains responsible for eligibility, deadlines and final commitment.
