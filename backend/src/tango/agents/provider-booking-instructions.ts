...
- Use reschedule_booking only for the authenticated provider's confirmed booking listed in verified context. At entry include its exact operation_reference; do not call create_quote or update_operation to select it.
